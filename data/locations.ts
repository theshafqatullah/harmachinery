...
export const dubaiLocations: Location[] = [
  ...
  },
  {
    ...
    name: "Film & Media Production Sites",
    slug: "film-media-production",
    region: "events",
    emirate: "Dubai",
    tier: 2,
    distance: "Various desert/outdoor",
    markets: ["film-media", "events"],
    description:
      "International and Bollywood productions shooting in desert and outdoor locations. Silent generators essential for on-location shoots.",
    equipmentDemand: "Silent generators (30–100 kVA), light towers",
    whyTarget:
      "Premium pricing — film industry pays top rates for reliable, quiet equipment. Desert locations are near us.",
    metaTitle:
      "Silent Generator Rental for Film & Media Production | Harma Machinery",
    metaDescription:
      "Rent silent generators for film production in Dubai desert locations. Harma Machinery provides ultra-quiet power solutions.",
  },
  {
    id: "data-centers",
    ...
    emirate: "Dubai",
    tier: 2,
    distance: "~20 km (DSO, Dubai South)",
    markets: ["construction", "industrial"],
    description:
      "Dubai's booming data center sector with new facility construction in DSO, Dubai South, and DIP. Data centers need construction power plus permanent generator backup.",
    equipmentDemand: "Heavy generators (500+ kVA), cranes, concrete pumps",
    whyTarget:
      "High-value clients who need premium reliability — willing to pay top rates.",
    metaTitle:
      "Generator & Equipment Rental for Data Center Construction | Harma Machinery",
    metaDescription:
      "Heavy generator rental for data center construction in Dubai. Harma Machinery provides mission-critical power solutions.",
  },
  {
    id: "sports-city",
  ...
  },
  {
    ...
    markets: ["construction"],
    description:
      "Premium equipment rental services in DAMAC Hills 1, serving luxury villa developments and landscaping projects.",
    equipmentDemand: "Generators, mini excavators, compactors",
    whyTarget:
      "Premium community with ongoing luxury villa construction.",
    metaTitle:
      "Generator & Equipment Rental in DAMAC Hills 1 | Harma Machinery",
    metaDescription:
      "Rent generators & construction equipment in DAMAC Hills 1. Harma Machinery provides reliable equipment with delivery.",
  },
  {
    id: "emirates-hills",
    name: "Emirates Hills",
    ...
    markets: ["construction"],
    description:
      "Specialized equipment rental for Emirates Hills premium villa construction and renovation projects.",
    equipmentDemand: "Generators, boom lifts, small cranes",
    whyTarget:
      "Ultra-premium location with high-budget renovation projects.",
    metaTitle:
      "Generator & Equipment Rental in Emirates Hills | Harma Machinery",
    metaDescription:
      "Premium construction equipment rental in Emirates Hills. Harma Machinery — quality machinery for luxury villa projects.",
  },
  {
    ...
    markets: ["construction"],
    description:
      "Exclusive construction machinery rental for Jumeirah Bay Island luxury development projects.",
    equipmentDemand: "Generators, small cranes, boom lifts",
    whyTarget:
      "Ultra-premium island development with exclusive clientele.",
    metaTitle:
      "Generator & Equipment Rental in Jumeirah Bay Island | Harma Machinery",
    metaDescription:
      "Premium equipment rental for Jumeirah Bay Island. Harma Machinery supports luxury island developments.",
  },
  {
    id: "mbr-city",
    ...
    markets: ["construction"],
    description:
      "Large-scale equipment rental for MBR City's mega development and infrastructure projects including District One villas.",
    equipmentDemand: "All types — generators, earthmoving, cranes",
    whyTarget:
      "Mega project with multi-year construction timeline.",
    metaTitle:
      "Generator & Equipment Rental in MBR City | Harma Machinery",
    metaDescription:
      "Construction equipment rental in Mohammed Bin Rashid City. Harma Machinery supports mega development projects.",
  },
  {
    id: "arabian-ranches",
    ...
    markets: ["construction"],
    description:
      "Trusted equipment rental for Arabian Ranches villa construction and community projects.",
    equipmentDemand: "Generators, mini excavators, compactors",
    whyTarget:
      "Established premium community with ongoing renovation and landscape needs.",
    metaTitle:
      "Generator & Equipment Rental in Arabian Ranches | Harma Machinery",
    metaDescription:
      "Rent construction equipment in Arabian Ranches. Harma Machinery delivers quality equipment for residential projects.",
  },
  {
    ...
    markets: ["construction"],
    description:
      "Comprehensive machinery solutions for Arabian Ranches 2 development needs.",
    equipmentDemand: "Generators, compactors, small excavators",
    whyTarget:
      "Active residential community with ongoing construction phases.",
    metaTitle:
      "Generator & Equipment Rental in Arabian Ranches 2 | Harma Machinery",
    metaDescription:
      "Equipment rental in Arabian Ranches 2. Generators, compactors & equipment from Harma Machinery.",
  },
  {
    id: "jvc",
    ...
    markets: ["construction"],
    description:
      "Affordable equipment rental for JVC construction and development projects with tower and villa construction.",
    equipmentDemand: "Generators, boom lifts, concrete pumps",
    whyTarget:
      "One of Dubai's most active construction areas with continuous new projects.",
    metaTitle: "Generator & Equipment Rental in JVC | Harma Machinery",
    metaDescription:
      "Construction equipment rental in Jumeirah Village Circle. Harma Machinery offers competitive rates.",
  },
  {
    id: "dubai-marina",
    name: "Dubai Marina",
